...
(() => {
  ...
  // ========== GLOBAL PAUSE / RESUME HANDLER: TAMAMEN DEVRE DISI (KULLANICI ISTEDI - yonlendirme sorunlari nedeniyle) ==========
  (function installGlobalPauseFix(){
    try{
      try{console.log('[PAUSEFIX] DEVRE DISI: Otomatik resume / eventlar KALDIRILDI.');}catch(_){}
    }catch(bigFatal){}
  })();
  // ========================================
